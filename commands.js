...
mek = mek.messages[0]
      ...
      case 'alive':
		...
		await conn.sendMessage(from , { audio : fs.readFileSync("./src/alive.mpeg") , mimetype : 'audio/mpeg' , ptt: true  } , { quoted: mek })
              ...
              { quickReplyButton: {displayText: 'القائمه', id: prefix +'menu' }} , 
              { quickReplyButton: {displayText: 'المطور', id: prefix +'owner' }}   
                                      ]
               const buttonMessage = {
               caption: alivemsg ,
...
await conn.sendMessage(from , { text: 'error' }, { quoted: mek } )  
 ...
 //_______________________________________________________________________________________________________________________________________________________   //		      
    ...
    const listMessage = {
      text: " \n\n name : " + q + '\n\n ',
      footer: config.FOOTER,
      title: '❤𝘉𝘖𝘛 𝘈𝘓𝘚𝘖𝘓𝘛𝘈𝘕❤ تحميل التطبيقات',
